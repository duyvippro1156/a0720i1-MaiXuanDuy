...
<nav id="navigation">
  <div class="navigation-flex">
        <span class="navigation-home">
            <ul>
                <li><a class="btn btn-outline-secondary btn-lg" role="button" aria-pressed="true" href="">Home</a></li>
                <li><a class="btn btn-outline-secondary btn-lg" role="button" aria-pressed="true" href="listCustomer">Customer</a></li>
                <li><a class="btn btn-outline-secondary btn-lg" role="button" aria-pressed="true" href="listEmployee">Employee</a></li>
