...
public class Contract {
    ...
    public Contract(int contract_id, String contract_start_date, String contract_end_date, String contract_deposit, String contract_total_money, int employee_id, int customer_id, int service_id) {
