...
<div class="film-page-2">
    <div class="container">
        <div class="login">
            <h1>Войти в личный кабинет</h1>
            <form class="login" method="post" action="${pageContext.servletContext.contextPath}/login_page">
        ...
        <div class="login-help">
            <a href="${pageContext.request.contextPath}/login_page">Забыли пароль?</a> Восстановить
        </div>
    </div>
</div>
<footer>
