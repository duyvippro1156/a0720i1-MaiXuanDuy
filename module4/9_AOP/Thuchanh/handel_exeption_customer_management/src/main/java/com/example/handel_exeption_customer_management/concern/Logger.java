package com.example.handel_exeption_customer_management.concern;
...
//    @AfterThrowing(pointcut = "execution(public * com.codegym.aopcustomermanagement.service.CustomerService.findAll(..))")
    @AfterThrowing(pointcut = "execution(public * com.example.handel_exeption_customer_management.service.CustomerService.*(..))", throwing = "e")
